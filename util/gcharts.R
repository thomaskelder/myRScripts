...
pieChartUrls = function(data, pieColors = colorRamp(c("blue", "white", "red")), lim = 2) {
  chartUrlBase = "http://chart.apis.google.com/chart?chs=100x100&cht=p&chp=1.571&chf=bg,s,FFFFFF00"
